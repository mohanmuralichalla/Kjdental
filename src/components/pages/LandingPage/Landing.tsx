    ...
    <>
      <div className="landing">
        ...
        <div className="schedule-img-container">
          ...
          <div className="schedule-content">
            ...
            <div>
              <button onClick={onBookAppointmentTextClick} className="schedule-btn">Book Appointment</button>
            </div>
          </div>
        </div>
      ...
      <div className="div14">
          ...
          <div className="div14">
            <div className="profile">
              <div className="text1">
                ...
                <div className="name1">
                  <div className="dental-patient">Dental Patient</div>
                  <div className="robert-davis">Vanseena</div>
                </div>
              </div>
              <img className="icon2" alt="" src="/icon2.svg" />
            </div>
          ...
          <div className="div14">
            <div className="profile">
              <div className="text1">
                ...
                <div className="name1">
                  <div className="dental-patient">Dental Patient</div>
                  <div className="robert-davis">Mark Brown</div>
                </div>
              </div>
              <img className="icon2" alt="" src="/icon2.svg" />
            </div>
          ...
          <div className="div14">
            <div className="profile">
              <div className="text1">
                <img className="image-icon1" alt="" src="/julie.png" />
                <div className="name1">
                  <div className="dental-patient">Dental Patient</div>
                  <div className="robert-davis">julie Davis</div>
                </div>
              </div>
              <img className="icon2" alt="" src="/icon2.svg" />
            </div>
